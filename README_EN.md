...
This is the public installation entry point for [KitTUI Mobile Lite](https://github.com/hcloudlab/kittui-mobile). It is currently Beta software. By default, the bootstrap pins core version `v0.2.0-beta.1` and does not execute code from the core repository's `main` branch.
